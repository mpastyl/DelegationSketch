...
plt.savefig(name)
plt.show()
#subprocess.Popen("/home/chasty/pdfcrop_v0.4b/pdfcrop "+name.split('/')[-1]+" "+name.split('/')[-1],shell=True)
...
#lgd=plt.legend()
#lgd = plt.legend(bbox_to_anchor=(0,0.8), loc="lower left", ncol = 3)
lgd = plt.legend(bbox_to_anchor=(0,1.02,1,0.2), loc="lower left", mode="expand", borderaxespad=0, ncol=3, prop=fontP)
#lgd = plt.legend(bbox_to_anchor=(0,0), loc="upper left", ncol = 3)
